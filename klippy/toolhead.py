...
class LookAheadQueue:
    ...
    def flush(self, lazy=False):
        ...
        # logging.info("flush flush_count:%s", flush_count)
...
class ToolHead:
    ...
    def _process_moves(self, moves):
        ...
        # logging.info("_process_moves print_time:%s", self.print_time)
        ...
        # logging.info("_process_moves next_move_time: %s", next_move_time)
        for move in moves:
            # logging.info("move:%s", move)
            if move.is_kinematic_move:
                # logging.info("is_ki_move")
                self.trapq_append(
            ...
            for cb in move.timing_callbacks:
                # logging.info("_process_moves callback:%s(%s)", cd, next_move_time)
                cb(next_move_time)
