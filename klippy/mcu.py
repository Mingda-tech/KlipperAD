...
class MCU:
    ...
    def __init__(self, config, clocksync):
        ...
        # #----------------------------------------------
        # self.advance_flush_moves_time = config.getfloat('advance_flush_moves_time', 0.0,
        #     minval = 0.0)
        # #----------------------------------------------
        # Stats
    ...
    def flush_moves(self, print_time, clear_history_time):
        ...
        # clock = self.print_time_to_clock(print_time + 
        #                                  self.advance_flush_moves_time)
        # logging.info("flush_moves:clock %s, print_time %s, afm %s",
        #              clock, print_time, self.advance_flush_moves_time)
        if clock < 0:
            return
